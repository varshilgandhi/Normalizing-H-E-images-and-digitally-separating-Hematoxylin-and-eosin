# -*- coding: utf-8 -*-
"""
Created on Tue Jul 27 18:28:56 2021
...
Normalizing H&E stained images for histology and separating H and E components of the images

H(HEMOTOXYN) and E(EIOSIN)

"""

"""

Steps for Normalizing H&E images

Input : RGB Slide

1. Covert RGB to OD
2. Convert data with OD intensity less than beta
3. Calculate SVD on the OD tuples
4. Create plane from the SVD directions corresponding to the largest singular values
5. Project data onto the plane, and normalize to unit length
6. Calculate angle of each point write the first SVD direction
7. Find robust extremes (alpha and (100 - alpha)th percentiles ) of the angle
8. Convert extreme values back to OD space

Output : Optimal stain vectors 

Full Form of SVD is Singular value decomposition and it is used to extract eigen values
